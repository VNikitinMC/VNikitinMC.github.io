...
ul {
    ...
    padding: 0;
    text-align: left; /* Для выравнивания элементов списка */
    margin: 0 auto; /* Центрируем список */
    width: 300px; /* Фиксируем ширину списка */
}
...
.button {
    ...
    width: 100px; /* Фиксируем ширину кнопки */
}

.hidden {
    display: none; /* Скрываем сообщение первоначально */
}
